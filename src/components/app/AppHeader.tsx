        ...
        <div className="container-section py-3 md:py-4">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 md:gap-6 min-w-0 flex-1">
              {/* Logo and Title */}
                <div className="flex items-center gap-2 md:gap-3 min-w-0 items-center">
                <div className="bg-slate-800 border border-slate-600 p-1.5 md:p-2 rounded-lg shrink-0">
                  <img
