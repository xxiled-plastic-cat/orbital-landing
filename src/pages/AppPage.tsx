        ...
        <div className="container-section py-12 min-h-[60vh] flex items-center justify-center">
          ...
          >
            <div className="relative mx-auto w-16 h-16 mb-6">
              <div className="absolute inset-0 bg-neon-teal opacity-20 blur-sm animate-pulse"></div>
              <div className="relative bg-neon-teal bg-opacity-20 p-4 flex items-center justify-center animate-pulse">
